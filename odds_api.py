...
def get_low_total_games(threshold: float = 8.0):
    ...
    if API_KEY == 'YOUR_API_KEY_HERE' or not API_KEY:
        st.warning("⚠️ Odds API Key not detected. Using mock data for testing. Please add 'ODDS_API_KEY' to Replit Secrets.")
        return {"Seattle Mariners": 7.0, "Houston Astros": 7.0, "Baltimore Orioles": 7.5, "New York Yankees": 7.5}
